...
#include "Components/PrimitiveComponent.h" // Needed for collision settings


// Sets default values
AInteractableTable::AInteractableTable()
{
	// Set this actor to call Tick() every frame. Turn this off to improve performance.
...
// REMOVED: Tick function is not needed
